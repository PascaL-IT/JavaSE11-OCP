package practice7.app;

import java.math.BigDecimal;
import java.time.LocalDate;
import java.util.Locale;

import practice7.data.Food;
import practice7.data.Product;
import practice7.data.ProductManager;
import practice7.data.Rateable;
import practice7.data.Rating;
...
public class Shop {
	...
	public static void main(String[] args) {
		...
		//Test review and print product report
		pm.prindProductReport();
		System.out.println(p1);
		pm.reviewProduct((Product) p1, Rating.TWO_STAR, "Finally, this tea is not so good...");
		pm.prindProductReport();
	}
