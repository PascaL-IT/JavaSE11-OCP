 ...
 *          History: <br>
 *          2.0 : add rating<br>
 * 			3.0 : add Rateable interface<br>
 *          4.0 : remove setters (a Product is immutable) <br>
 *          5.0 : add Serializable<br>
 *          <br>
 */
...
public abstract class Product implements Rateable<Product>, Serializable {
	 ...
	 * Serializable
	 */
	private static final long serialVersionUID = -8468370253078946408L;
	...
	public boolean equals(Object obj) {
		...
		if (id != other.id)
			return false;
// TODO - check and decide if it's OK to distinguish products only by id
//		if (name == null) {
//			if (other.name != null)
//				return false;
